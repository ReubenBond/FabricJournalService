namespace ReliableJournal.Log
{
    ...
    internal class LogFile : IDisposable
    {
        ...
        public LogFile(Action<string> logger)
        {
            this.logger = logger;
        }
        ...
        {
            return this.log.ReadLogRecords(this.log.LastSequenceNumber, LogRecordEnumeratorType.Previous).Take(1).FirstOrDefault();
        }
